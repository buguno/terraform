...
| Name | Description |
| ---- | ----------- |
| <a name="output_certificate_authority"></a> [certificate\_authority](#output\_certificate\_authority) | Base64-encoded certificate authority data for the EKS cluster. |
| <a name="output_cluster_name"></a> [cluster\_name](#output\_cluster\_name) | The name of the EKS cluster. |
| <a name="output_endpoint"></a> [endpoint](#output\_endpoint) | The API server endpoint URL of the EKS cluster. |
| <a name="output_oidc"></a> [oidc](#output\_oidc) | The OIDC issuer URL of the EKS cluster, used for IAM role federation. |
<!-- END_TF_DOCS -->
